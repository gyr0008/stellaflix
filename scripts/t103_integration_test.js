...
var loadOrder = [
  ...
  'subtitle.js', 'player-core.js', 'player.js', 'source-adapter-core.js', 'source-adapter.js', 'sources-core.js', 'sources.js',
  'fx-sources.js',       // ← L49
  'online-core.js',      // ← #6-序7：online 纯过滤谓词核心，须先于 online.js
  'online-shared.js',    // ← #1：共享状态层（须紧接 core）
  'online-search.js',    // ← #1：搜索页 + 过滤 UI 子模块
  'online-collections.js', // ← #1：片单子模块
  'online-track.js',     // ← #1：追片子模块
  'online.js',           // ← #1：协调器（装配 facade）
  // kazumi 子目录 (L52-57)
  ...
  'kazumi-bridge-core.js', 'kazumi-bridge.js',    // ← L58
  // danmaku (L60-66)
