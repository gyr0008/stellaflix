...
// 筛选选项
const GENRES = ["全部", "喜剧", "爱情", "恐怖", "动作", "科幻", "剧情", "犯罪", "奇幻", "悬疑", "惊悚", "家庭", "冒险", "战争", "灾难"];
const REGIONS = ["全部", "中国", "大陆", "香港", "台湾", "美国", "韩国", "日本", "泰国", "新加坡", "印度", "英国", "法国", "其它"];
...
export default function MoviesPage() {
  const [activeChannel, setActiveChannel] = useState("movie");
