...
![Stellaflix 暗场启动页](./docs/assets/readme/stellaflix-splash.png)

> 非官方二创版本，基于 [XxHuberrr/Mineradio](https://github.com/XxHuberrr/Mineradio)。>   
> 本仓库用于在尊重原作者和 GPL-3.0 授权的前提下，维护更多音源、歌单导入和个性化体验扩展。

Stellaflix 是一款 Windows 桌面沉浸式音乐播放器。原版 Mineradio 已经提供天气电台、搜索播放、歌词舞台、粒子视觉和 3D 歌单架；本扩展版在此基础上补充酷狗概念版、普通酷狗音乐、汽水音乐歌单导入、个性化 Home 面板和更自由的 DIY 视觉工坊。
...
[下载 Stellaflix 最新版](https://github.com/gyr0008/stellaflix/releases/latest)
...
欢迎对 Stellaflix 感兴趣的朋友加群交流使用体验、问题反馈和二创想法。

二维码会定期过期，如果图片失效，请以仓库后续更新为准。

| 微信群聊                                                                                                    | 抖音群聊                                                                                                      |
| ------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| <img src="./docs/assets/community/wechat-group-2026-07-12.jpg" alt="Stellaflix 二创交流群 微信群聊" width="300"> | <img src="./docs/assets/community/douyin-group-2026-07-12.jpg" alt="Stellaflix 二创版本交流群 抖音群聊" width="300"> |
