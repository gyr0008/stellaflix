...
`),transparent:!0,depthWrite:!1,depthTest:!0,blending:THREE.NormalBlending});return skullParticleGroup=new THREE.Points(M,R),skullParticleGroup.frustumCulled=!1,skullParticleGroup.visible=!1,skullParticleGroup.userData.source=e?"asset":"fallback",skullParticleGroup.position.set(SKULL_MODEL_BASE_POSITION.x,SKULL_MODEL_BASE_POSITION.y,SKULL_MODEL_BASE_POSITION.z),skullParticleGroup.scale.setScalar(SKULL_MODEL_SCALE),skullParticleGroup.rotation.x=SKULL_MODEL_BASE_ROTATION_X,skullParticleGroup.rotation.y=SKULL_MODEL_BASE_ROTATION_Y,skullParticleGroup.renderOrder=32,syncSkullParticleColors(),scene.add(skullParticleGroup),skullParticleGroup}function isSkullShelfCompositionActive(){return!(fx&&fx.preset===SKULL_PRESET_INDEX)||!shelfManager||!shelfManager.getMode||shelfManager.getMode()!=="side"?!1:shelfPinnedOpen||shelfVisibility>.18?!0:!!(shelfManager.hasOpenContent&&shelfManager.hasOpenContent())}function clearSkullPresetResidue(){skullParticleOpacity=0,skullAmpPulse=0,skullBeatFlash=0,skullJawOpen=0,skullCameraBlend=0,skullParticleGroup&&(skullParticleGroup.visible=!1,skullParticleGroup.material&&skullParticleGroup.material.uniforms&&(skullParticleGroup.material.uniforms.uOpacity&&(skullParticleGroup.material.uniforms.uOpacity.value=0),skullParticleGroup.material.uniforms.uJawOpen&&(skullParticleGroup.material.uniforms.uJawOpen.value=0),skullParticleGroup.material.uniforms.uSkullFlash&&(skullParticleGroup.material.uniforms.uSkullFlash.value=0)))}function resetSkullPresetView(e,o){if(o=o||{},!!(fx&&fx.preset===SKULL_PRESET_INDEX)&&(skullWheelZoomTarget=0,o.smooth||(skullWheelZoom=0),skullCameraBlend=Math.max(skullCameraBlend,1),!o.keepLyricLock&&typeof stageLyrics<"u"&&stageLyrics&&stageLyrics.group&&stageLyrics.group.userData&&(stageLyrics.group.userData.skullMouthLocked=!1),!o.keepLyricLock&&typeof requestStageLyricCameraSnap=="function"&&requestStageLyricCameraSnap(10),!(!e||!skullParticleGroup))){var a=isSkullShelfCompositionActive();if(skullShelfCameraMix=a?1:0,skullParticleGroup.position.set(a?-1.18:SKULL_MODEL_BASE_POSITION.x,a?.32:SKULL_MODEL_BASE_POSITION.y,SKULL_MODEL_BASE_POSITION.z),skullParticleGroup.scale.setScalar(a?3.02:SKULL_MODEL_SCALE),skullParticleGroup.rotation.set(SKULL_MODEL_BASE_ROTATION_X,SKULL_MODEL_BASE_ROTATION_Y,0),skullParticleGroup.updateMatrixWorld(!0),camera&&typeof setSkullCameraTargetVectors=="function"){var t=innerHeight>innerWidth*1.08;setSkullCameraTargetVectors(skullCameraTargetPos,skullCameraTargetLook,t,a,0),camera.position.copy(skullCameraTargetPos),skullCameraMixedLook.copy(skullCameraTargetLook),camera.lookAt(skullCameraMixedLook),camera.updateProjectionMatrix()}}}function skullBreathOffset(e,o){var a=o?.7:1;return{x:a*(Math.sin(e*.33+1.7)*.028+Math.sin(e*.61+.4)*.01),y:a*(Math.sin(e*.38+.2)*.036+Math.sin(e*.83+2.1)*.012),z:a*(Math.sin(e*.24+2.6)*.026)}}function setSkullCameraTargetVectors(e,o,a,t,r){if(r=Number(r)||0,t){e.set(a?-.06:0,a?-2.36:-2.5,(a?4.88:4.96)+r*.78),o.set(a?-.04:0,a?-.26:-.2,.03);return}e.set(0,a?-2.38:-2.52,(a?4.92:4.98)+r),o.set(0,a?-.28:-.2,.02)}function applySkullCameraPose(e){if(!(freeCamera&&(freeCamera.active||freeCamera.locked||freeCamera.resetTween))){var o=fx&&fx.preset===SKULL_PRESET_INDEX;if(skullCameraBlend+=((o?1:0)-skullCameraBlend)*Math.min(1,e*(o?4.8:7.2)),!(skullCameraBlend<.002)){skullWheelZoom+=(skullWheelZoomTarget-skullWheelZoom)*Math.min(1,e*8);var a=innerHeight>innerWidth*1.08,t=isSkullShelfCompositionActive(),r=t?1:0;skullShelfCameraMix+=(r-skullShelfCameraMix)*Math.min(1,e*(r>skullShelfCameraMix?4.6:5.8)),Math.abs(skullShelfCameraMix-r)<.002&&(skullShelfCameraMix=r),setSkullCameraTargetVectors(skullCameraBasePos,skullCameraBaseLook,a,!1,skullWheelZoom),setSkullCameraTargetVectors(skullCameraShelfPos,skullCameraShelfLook,a,!0,skullWheelZoom),skullCameraTargetPos.copy(skullCameraBasePos).lerp(skullCameraShelfPos,skullShelfCameraMix),skullCameraTargetLook.copy(skullCameraBaseLook).lerp(skullCameraShelfLook,skullShelfCameraMix),camera.position.lerp(skullCameraTargetPos,skullCameraBlend),skullCameraMixedLook.set(orbit.lookAt.x,orbit.lookAt.y,orbit.lookAt.z).lerp(skullCameraTargetLook,skullCameraBlend),camera.lookAt(skullCameraMixedLook),camera.updateProjectionMatrix()}}}function updateSkullParticleLayer(e){var o=fx&&fx.preset===SKULL_PRESET_INDEX;if(o&&!skullParticleAsset.data&&!skullParticleAsset.failed){loadSkullParticleAsset();return}if(!(o&&!skullParticleAsset.data)&&(o&&createSkullParticleLayer(),!!skullParticleGroup)){var a=o?1:0;if(skullParticleOpacity+=(a-skullParticleOpacity)*Math.min(1,e*(o?3.2:2.4)),skullParticleOpacity<.006&&!o){skullParticleGroup.visible=!1;return}skullParticleGroup.visible=!0,skullParticleGroup.material.uniforms.uOpacity.value=skullParticleOpacity*clampRange(.78+(fx.intensity||.85)*.18,.56,1);var t=clampRange(Math.max(0,beatPulse-.16)/.84,0,1.35),r=clampRange(Math.pow(t,1.34)*1.08+Math.max(0,bass-.6)*.18*t,0,1);skullBeatFlash+=(r-skullBeatFlash)*Math.min(1,e*(r>skullBeatFlash?24:6.2)),skullParticleGroup.material.uniforms.uSkullFlash&&(skullParticleGroup.material.uniforms.uSkullFlash.value=skullBeatFlash);var i=clampRange(.6+(.5+.5*Math.sin(uniforms.uTime.value*.5))*.05+bass*.06+skullBeatFlash*.09,.52,.88);skullJawOpen+=(i-skullJawOpen)*Math.min(1,e*(i>skullJawOpen?7.8:3.4)),skullParticleGroup.material.uniforms.uJawOpen&&(skullParticleGroup.material.uniforms.uJawOpen.value=skullJawOpen);var s=isSkullShelfCompositionActive(),l=clampRange(skullShelfCameraMix||(s?1:0),0,1),u=skullBreathOffset(uniforms.uTime.value,s),n=clampRange(bass*.006+mid*.004+skullBeatFlash*.07,0,.09);skullAmpPulse+=(n-skullAmpPulse)*Math.min(1,e*(n>skullAmpPulse?11:4));var d=3.02,v=(SKULL_MODEL_SCALE+(d-SKULL_MODEL_SCALE)*l)*(1+skullAmpPulse)*clampRange(1-skullWheelZoom*.055,.92,1.08),f=-1.18,h=.32,c=SKULL_MODEL_BASE_POSITION.x+(f-SKULL_MODEL_BASE_POSITION.x)*l+u.x,g=SKULL_MODEL_BASE_POSITION.y+(h-SKULL_MODEL_BASE_POSITION.y)*l+u.y,M=SKULL_MODEL_BASE_POSITION.z+u.z;skullParticleGroup.position.x+=(c-skullParticleGroup.position.x)*Math.min(1,e*4.2),skullParticleGroup.position.y+=(g-skullParticleGroup.position.y)*Math.min(1,e*4.8),skullParticleGroup.position.z+=(M-skullParticleGroup.position.z)*Math.min(1,e*4.2),skullParticleGroup.scale.x+=(v-skullParticleGroup.scale.x)*Math.min(1,e*4.6),skullParticleGroup.scale.y=skullParticleGroup.scale.x,skullParticleGroup.scale.z=skullParticleGroup.scale.x;var R=SKULL_MODEL_BASE_ROTATION_Y+(orbit.centerLocked?0:(headParallax.active?headParallax.x*.5:0)+gestureRotation.y),B=SKULL_MODEL_BASE_ROTATION_X+(orbit.centerLocked?0:(headParallax.active?-headParallax.y*.35:0)+gestureRotation.x),A=Math.min(1,e*7.4);skullParticleGroup.rotation.y+=(R-skullParticleGroup.rotation.y)*A,skullParticleGroup.rotation.x+=(B-skullParticleGroup.rotation.x)*A,skullParticleGroup.rotation.z+=(0-skullParticleGroup.rotation.z)*Math.min(1,e*6)}}var BACK_COVER_COUNT=3e3,backCoverGroup=null,backCoverColorArr=null;function createBackCoverLayer(){if(!backCoverGroup){for(var e=new THREE.BufferGeometry,o=new Float32Array(BACK_COVER_COUNT*3),a=new Float32Array(BACK_COVER_COUNT*3),t=new Float32Array(BACK_COVER_COUNT),r=new Float32Array(BACK_COVER_COUNT*2),i=0;i<BACK_COVER_COUNT;i++){var s=Math.random(),l=Math.random();o[i*3]=(s-.5)*PLANE_SIZE,o[i*3+1]=(l-.5)*PLANE_SIZE,o[i*3+2]=-1.5-Math.random()*.4,r[i*2]=1-s,r[i*2+1]=l,t[i]=Math.random(),a[i*3]=.7,a[i*3+1]=.6,a[i*3+2]=.8}e.setAttribute("position",new THREE.BufferAttribute(o,3)),e.setAttribute("aColor",new THREE.BufferAttribute(a,3)),e.setAttribute("aRand",new THREE.BufferAttribute(t,1)),e.setAttribute("aUv",new THREE.BufferAttribute(r,2));var u=`
    precision highp float;
  ...
  `,d=new THREE.ShaderMaterial({uniforms:{uTime:uniforms.uTime,uBass:uniforms.uBass,uPixel:uniforms.uPixel,uDotTex:uniforms.uDotTex,uAlpha:uniforms.uAlpha},vertexShader:u,fragmentShader:n,transparent:!0,depthWrite:!1,blending:THREE.NormalBlending});backCoverGroup=new THREE.Points(e,d),backCoverGroup.frustumCulled=!1,backCoverColorArr=a,scene.add(backCoverGroup)}}function destroyBackCoverLayer(){backCoverGroup&&(scene.remove(backCoverGroup),backCoverGroup.geometry.dispose(),backCoverGroup.material.dispose(),backCoverGroup=null,backCoverColorArr=null)}function refreshBackCoverColorsFromCanvas(e){if(!(!backCoverGroup||!e||!backCoverColorArr)){for(var o=e.getContext("2d"),a=o.getImageData(0,0,e.width,e.height).data,t=e.width,r=e.height,i=backCoverGroup.geometry.attributes,s=i.aUv.array,l=0;l<BACK_COVER_COUNT;l++){var u=s[l*2],n=s[l*2+1],d=Math.floor(u*t),v=Math.floor(n*r),f=(v*t+d)*4;backCoverColorArr[l*3]=a[f]/255*.85,backCoverColorArr[l*3+1]=a[f+1]/255*.85,backCoverColorArr[l*3+2]=a[f+2]/255*.85}i.aColor.needsUpdate=!0}}function updateFloatLayer(e){}function refreshFloatColorsFromCover(e){if(!(!floatGroup||!e)){for(var o=e.getContext("2d"),a=o.getImageData(0,0,e.width,e.height).data,t=e.width,r=e.height,i=0;i<FLOAT_COUNT;i++){var s=Math.floor(Math.random()*t),l=Math.floor(Math.random()*r),u=(l*t+s)*4;floatColorArr[i*3]=a[u]/255*.95,floatColorArr[i*3+1]=a[u+1]/255*.95,floatColorArr[i*3+2]=a[u+2]/255*.95}floatGroup.geometry.attributes.aColor.needsUpdate=!0}}function resetFloatColorsToIdle(){if(!(!floatGroup||!floatColorArr)){for(var e=0;e<FLOAT_COUNT;e++){var o=.88+e%17/17*.12;floatColorArr[e*3]=o,floatColorArr[e*3+1]=o,floatColorArr[e*3+2]=o}floatGroup.geometry.attributes.aColor.needsUpdate=!0}}for(var rippleIdx=0,lastRippleAt=0,lastBassRising=!1,BASS_THRESHOLD=.3,RIPPLE_COOLDOWN=.32,regions=[],ry=0;ry<3;ry++)for(var rx=0;rx<3;rx++)regions.push({x:(rx/2-.5)*PLANE_SIZE*.72,y:(ry/2-.5)*PLANE_SIZE*.72});function triggerRipple(e,o,a){var t=ripples[rippleIdx];t.x=e,t.y=o,t.age=0,t.str=a,rippleIdx=(rippleIdx+1)%RIPPLE_MAX}function updateRipples(e){var o=bass>BASS_THRESHOLD&&!lastBassRising;lastBassRising=bass>BASS_THRESHOLD*.75;var a=uniforms.uTime.value;if(o&&a-lastRippleAt>RIPPLE_COOLDOWN){lastRippleAt=a;for(var t=2+(Math.random()<.5?0:1),r={},i=0;i<t;i++){var s,l=0;do s=Math.floor(Math.random()*9),l++;while(r[s]&&l<12);r[s]=!0;var u=regions[s],n=u.x+(Math.random()-.5)*.7,d=u.y+(Math.random()-.5)*.7,v=.65+bass*1.4+Math.random()*.25;triggerRipple(n,d,v)}}for(var f=0;f<RIPPLE_MAX;f++){var h=ripples[f];h.str>.005&&(h.age+=e,h.age>2&&(h.str=0,h.age=-10));var c=f*4;rippleData[c]=h.x,rippleData[c+1]=h.y,rippleData[c+2]=h.age,rippleData[c+3]=h.str}rippleTex.needsUpdate=!0;for(var g=0,f=0;f<RIPPLE_MAX;f++)ripples[f].str>.005&&g++;uniforms.uRippleCount.value=g}function customShapeRecipeForRender(){return shapeWorkshopState&&shapeWorkshopState.open?shapeWorkshopPreviewRecipeForRender():activeUserShapeRecipe&&fx&&Number(fx.preset)===3?normalizeShapeRecipe(activeUserShapeRecipe):null}function ensureCustomShapeGroup(){return customShapeGroup||(customShapeGroup=new THREE.Group,customShapeGroup.name="MineradioCustomShapePreset",customShapeGroup.visible=!1,customShapeGroup.renderOrder=24,scene.add(customShapeGroup),customShapeGroup)}function disposeCustomShapeObject(e){e&&(e.geometry&&e.geometry.dispose&&e.geometry.dispose(),e.material&&e.material.dispose&&e.material.dispose())}function clearCustomShapeLayer(){if(customShapeGroup){for(;customShapeGroup.children.length;){var e=customShapeGroup.children[0];customShapeGroup.remove(e),disposeCustomShapeObject(e)}customShapeRecipeKey="",customShapeRenderRecipe=null,customShapeGroup.visible=!1}}function customShapeSeedFromId(e,o){for(var a=String(e||"shape")+":"+o,t=0,r=0;r<a.length;r++)t=(t*31+a.charCodeAt(r))%1e5;return t+17}function customShapeRand(e){var o=Math.sin(e*12.9898)*43758.5453;return o-Math.floor(o)}function customShapeCoverSampler(){var e=ensureShapeMaterialCanvas()||coverPickerCanvas||(coverTex&&coverTex.image&&coverTex.image.getContext?coverTex.image:null);if(!e||!e.getContext)return null;try{var o=e.getContext("2d"),a=o.getImageData(0,0,e.width,e.height).data;return function(t,r){var i=clampRange(Math.floor(clampRange(t,0,.999)*e.width),0,e.width-1),s=clampRange(Math.floor(clampRange(r,0,.999)*e.height),0,e.height-1),l=(s*e.width+i)*4;return[a[l]/255,a[l+1]/255,a[l+2]/255]}}catch{return null}}function customShapePalette(){var e=stageLyrics&&(stageLyrics.coverPalette||stageLyrics.palette)||{},o=normalizeHexColor(e.primary||fx.visualTintColor||fxDefaults.visualTintColor||"#9db8cf","#9db8cf"),a=normalizeHexColor(e.secondary||fx.uiAccentColor||fxDefaults.uiAccentColor||"#f4d28a","#f4d28a");return{a:new THREE.Color(o),b:new THREE.Color(a),mono:new THREE.Color("#eaf2f5")}}function customShapeColorForPoint(e,o,a,t,r,i){if(e.material==="mono")return[i.mono.r,i.mono.g,i.mono.b];if(e.material==="cover"&&o){var s=o(a,t),l=.22+customShapeRand(r+21)*.22;return[clampRange(s[0]+l,0,1),clampRange(s[1]+l,0,1),clampRange(s[2]+l,0,1)]}var u=clampRange(.25+customShapeRand(r+9)*.65,0,1),n=i.a.clone().lerp(i.b,e.material==="accent"?.7:u);return[n.r,n.g,n.b]}function customShapeUsesCoverTexture(e){return e=normalizeShapeRecipe(e),!!(e.materialBinding&&e.materialBinding.mode==="cover-texture"&&e.primitives.some(function(o){return o.material==="cover"}))}function customShapeTextureReady(){return!!(ensureShapeMaterialCanvas()||coverTex&&coverTex.image)}function customShapeCoverParticleMaterial(e,o){return new THREE.PointsMaterial({size:clampRange(.03+(Number(o)||0),.028,.09),map:dotTexture,vertexColors:!0,transparent:!0,opacity:clampRange(e,.14,.96),depthWrite:!1,sizeAttenuation:!0,blending:THREE.AdditiveBlending})}function applyCustomShapePrimitiveTransform(e,o){e.position.set(o.x*2.55,-o.y*2.05,o.z*2.55),e.rotation.set(o.depth*.34,o.rotation*Math.PI*.34,o.rotation*Math.PI*2)}function buildCustomShapeCoverParticlePoints(e){e=e||{};var o=Math.max(48,Math.min(1400,Math.round(Number(e.count)||420))),a=Math.max(8,Math.round(Math.sqrt(o*(e.aspect||1)))),t=Math.max(8,Math.ceil(o/a));o=a*t;for(var r=Number(e.width)||1.4,i=Number(e.height)||1.4,s=Number(e.depth)||.18,l=customShapeSeedFromId(e.id||"cover-particles",Number(e.index)||0),u=customShapeCoverSampler(),n=customShapePalette(),d=new Float32Array(o*3),v=new Float32Array(o*3),f=new Float32Array(o),h=new Float32Array(o*3),c=0;c<o;c++){var g=c%a,M=Math.floor(c/a),R=a>1?g/(a-1):.5,B=t>1?M/(t-1):.5,A=customShapeRand(l+c*11+3),P=(R-.5)*r,b=(B-.5)*i,D=(A-.5)*s;v[c*3]=P,v[c*3+1]=b,v[c*3+2]=D,d[c*3]=P,d[c*3+1]=b,d[c*3+2]=D,f[c]=A;var E=u?u(R,B):null;E||(E=[n.a.r,n.a.g,n.a.b]);var S=.08+customShapeRand(l+c*7+17)*.13;h[c*3]=clampRange(E[0]+S,0,1),h[c*3+1]=clampRange(E[1]+S,0,1),h[c*3+2]=clampRange(E[2]+S,0,1)}var T=new THREE.BufferGeometry;T.setAttribute("position",new THREE.BufferAttribute(d,3)),T.setAttribute("color",new THREE.BufferAttribute(h,3)),T.userData.basePositions=v,T.userData.rand=f;var k=customShapeCoverParticleMaterial(e.opacity,e.sizeBoost),w=new THREE.Points(T,k);return w.frustumCulled=!1,w}function customShapeLocalPoint(e,o,a,t){var r=a>1?o/(a-1):0,i=customShapeRand(t+o*3+1),s=customShapeRand(t+o*3+2),l=customShapeRand(t+o*3+3),u=e.size,n=e.depth,d=r*Math.PI*2,v=0,f=0,h=0,c=r,g=s;if(e.type==="line")v=(r-.5)*3.2*u,f=(i-.5)*.08*u,h=(s-.5)*n*1.2,g=.5+f;else if(e.type==="ring"){var M=(.82+(i-.5)*.08)*u;v=Math.cos(d)*M,f=Math.sin(d)*M,h=Math.sin(d*2+s*2)*n*.3,c=.5+Math.cos(d)*.48,g=.5+Math.sin(d)*.48}else if(e.type==="curve"){var R=r*Math.PI*2,B=(i-.5)*.18,A=Math.sin(R),P=Math.sin(R)*Math.cos(R);v=(A*1.46+Math.cos(R)*B)*u,f=(P*1.08+Math.sin(R*2)*B*.5)*u,h=(Math.cos(R*2)*.34+(s-.5)*.42)*n*u,c=clampRange(.5+A*.46,0,1),g=clampRange(.5+P*.46,0,1)}else if(e.type==="plane"||e.type==="card"){var b=Math.max(2,Math.round(Math.sqrt(a*(e.type==="card"?1.55:1)))),D=o%b,E=Math.floor(o/b),S=Math.max(2,Math.ceil(a/b));c=b>1?D/(b-1):.5,g=S>1?E/(S-1):.5;var T=e.type==="card"?1.42:1;v=(c-.5)*2.1*u*T,f=(g-.5)*2.1*u,h=(l-.5)*n*.18}else if(e.type==="spiral"){var k=2.2+n*1.6;d=r*Math.PI*2*k;var w=Math.pow(r,.72)*1.35*u+(i-.5)*.1;v=Math.cos(d)*w,f=Math.sin(d)*w,h=(r-.5)*n*2.4+Math.sin(d*.5)*n*.24,c=.5+Math.cos(d)*Math.min(.48,w*.24),g=.5+Math.sin(d)*Math.min(.48,w*.24)}else if(e.type==="wave"){var p=Math.max(2,Math.round(Math.sqrt(a))),m=o%p,y=Math.floor(o/p),C=Math.max(2,Math.ceil(a/p));c=p>1?m/(p-1):.5,g=C>1?y/(C-1):.5,v=(c-.5)*2.5*u,f=(g-.5)*1.7*u,h=Math.sin(c*Math.PI*3+g*Math.PI*1.6)*n*.62}else if(e.type==="tunnel"){var x=Math.max(4,Math.round(Math.sqrt(a)*.55)),L=o%x,H=Math.floor(o/x),N=H/Math.max(1,Math.ceil(a/x)-1);d=L/x*Math.PI*2+i*.18;var V=(.78+s*.18)*u;v=Math.cos(d)*V,f=Math.sin(d)*V,h=(N-.5)*(2.2+n*3.2),c=L/x,g=N}else if(e.type==="sphere"){var O=Math.acos(1-2*r),K=Math.PI*(3-Math.sqrt(5))*o,z=(.92+(i-.5)*.08+n*.08)*u;v=Math.sin(O)*Math.cos(K)*z,f=Math.cos(O)*z,h=Math.sin(O)*Math.sin(K)*z,c=.5+Math.atan2(h,v)/(Math.PI*2),g=.5-Math.asin(f/Math.max(.001,z))/Math.PI}else if(e.type==="dust"){var U=i*Math.PI*2,_=Math.pow(s,.42)*(1.25+n*1.5)*u;v=Math.cos(U)*_,f=(l-.5)*(1.8+n)*u,h=Math.sin(U)*_+(customShapeRand(t+o*5+4)-.5)*n*2.4,c=i,g=s}else{var I=i*Math.PI*2,Y=Math.pow(s,.55)*.58*u;v=Math.cos(I)*Y,f=Math.sin(I)*Y,h=(l-.5)*n*1.4,c=i,g=s}return{x:v,y:f,z:h,u:clampRange(c,0,1),v:clampRange(g,0,1)}}function buildCustomShapePrimitiveCoverObject(e,o,a){if(e=normalizeShapePrimitive(e,o),a=normalizeShapeRecipe(a),!customShapeTextureReady()||!customShapeUsesCoverTexture(a)||e.material!=="cover"||e.type!=="plane"&&e.type!=="card")return null;var t=e.type==="card"?1.42:1,r=buildCustomShapeCoverParticlePoints({id:e.id+"-cover-particles",index:o,count:Math.max(180,Math.round(e.count*1.25)),width:2.1*e.size*t,height:2.1*e.size,depth:Math.max(.08,e.depth*.32),aspect:t,opacity:e.opacity*(e.type==="card"?.58:.52),sizeBoost:e.size*.01});return r.name="MineradioCustomShapeCoverParticlePrimitive",r.renderOrder=23+o,applyCustomShapePrimitiveTransform(r,e),r.userData.primitive=e,r.userData.layerIndex=o,r.userData.coverParticles=!0,r.userData.coverBaseOpacity=r.material.opacity,r}function buildCustomShapeCoverPlate(e){if(e=normalizeShapeRecipe(e),!customShapeTextureReady()||!customShapeUsesCoverTexture(e))return null;var o=e.primitives.some(function(i){return i.type==="plane"||i.type==="card"});if(o)return null;var a=e.primitives.reduce(function(i,s){return i+s.size},0)/Math.max(1,e.primitives.length),t=clampRange(1.1+a*.32+Math.min(e.primitives.length,4)*.05,1.12,1.62),r=buildCustomShapeCoverParticlePoints({id:"cover-particle-plate",index:0,count:Math.max(360,Math.min(1100,Math.round(shapeRecipeTotalParticles(e)*.72))),width:t,height:t,depth:.2,aspect:1,opacity:.62,sizeBoost:.012});return r.name="MineradioCustomShapeCoverParticlePlate",r.renderOrder=22,r.position.set(0,0,-.32),r.rotation.set(-.1,0,0),r.userData.primitive={id:"cover-particle-plate",type:"plane",x:0,y:0,z:-.12,count:r.geometry&&r.geometry.userData&&r.geometry.userData.rand?r.geometry.userData.rand.length:420,size:1,depth:.38,rotation:.08,audioFollow:.78,opacity:.62,material:"cover"},r.userData.layerIndex=-1,r.userData.coverParticles=!0,r.userData.coverPlate=!0,r.userData.coverBaseOpacity=r.material.opacity,r}function buildCustomShapePrimitiveObject(e,o){e=normalizeShapePrimitive(e,o);for(var a=!!(shapeWorkshopState&&shapeWorkshopState.open&&e.id&&e.id===shapeWorkshopState.selectedId),t=Math.max(8,Math.min(1200,e.count)),r=customShapeSeedFromId(e.id,o),i=new Float32Array(t*3),s=new Float32Array(t*3),l=new Float32Array(t),u=new Float32Array(t*3),n=customShapeCoverSampler(),d=customShapePalette(),v=0;v<t;v++){var f=customShapeLocalPoint(e,v,t,r);s[v*3]=f.x,s[v*3+1]=f.y,s[v*3+2]=f.z,i[v*3]=f.x,i[v*3+1]=f.y,i[v*3+2]=f.z,l[v]=customShapeRand(r+v*7+5);var h=customShapeColorForPoint(e,n,f.u,f.v,r+v,d);u[v*3]=h[0],u[v*3+1]=h[1],u[v*3+2]=h[2]}var c=new THREE.BufferGeometry;c.setAttribute("position",new THREE.BufferAttribute(i,3)),c.setAttribute("color",new THREE.BufferAttribute(u,3)),c.userData.basePositions=s,c.userData.rand=l;var g=new THREE.PointsMaterial({size:clampRange(.026+e.size*.024+e.depth*.012+(a?.014:0),.024,.095),map:dotTexture,vertexColors:!0,transparent:!0,opacity:clampRange(e.opacity*(a?1.16:1),.12,1),depthWrite:!1,sizeAttenuation:!0,blending:a||e.type==="dust"||e.type==="spiral"?THREE.AdditiveBlending:THREE.NormalBlending}),M=new THREE.Points(c,g);return M.frustumCulled=!1,M.renderOrder=24+o,applyCustomShapePrimitiveTransform(M,e),M.userData.primitive=e,M.userData.layerIndex=o,M}function syncCustomShapeLayer(e){var o=customShapeRecipeForRender(),a=ensureCustomShapeGroup();if(shapeWorkshopState&&shapeWorkshopState.open&&!shapeWorkshopState.motionPreview&&(a.rotation.set(0,0,0),a.userData.autoSpinY=0),!o||!o.primitives||!o.primitives.length){clearCustomShapeLayer();return}var t=shapeRecipeRenderKey(o);if(!e&&t===customShapeRecipeKey){a.visible=!0;return}clearCustomShapeLayer(),customShapeRenderRecipe=normalizeShapeRecipe(o);var r=buildCustomShapeCoverPlate(customShapeRenderRecipe);r&&a.add(r),customShapeRenderRecipe.primitives.forEach(function(i,s){var l=buildCustomShapePrimitiveCoverObject(i,s,customShapeRenderRecipe);l&&a.add(l),a.add(buildCustomShapePrimitiveObject(i,s))}),customShapeRecipeKey=t,a.visible=!0}function isCustomShapeRenderActive(){return!!(customShapeGroup&&customShapeGroup.visible&&customShapeRenderRecipe&&customShapeRenderRecipe.primitives&&customShapeRenderRecipe.primitives.length)}function shapeWorkshopHasLiveAudio(){return!!(audio&&playing&&!audio.paused&&!audio.ended)}function shapeWorkshopDemoAudioEnergy(e){var o=Math.pow(Math.max(0,Math.sin(e*Math.PI*1.65)),5),a=Math.pow(Math.max(0,Math.sin(e*Math.PI*.58+1.1)),2);return clampRange(.18+o*.78+a*.16,0,1.12)}function updateCustomShapeLayer(e){if(isCustomShapeRenderActive()){var o=uniforms.uTime.value,a=!!(shapeWorkshopState&&shapeWorkshopState.open&&!shapeWorkshopState.motionPreview),t=typeof isCustomShapeLayerDriftLocked=="function"&&isCustomShapeLayerDriftLocked(customShapeRenderRecipe),r=a?0:clampRange((bass*.58+mid*.3+treble*.22+beatPulse*.55)*(fx.intensity||1),0,1.4);if(!a&&shapeWorkshopState&&shapeWorkshopState.open&&shapeWorkshopState.motionPreview&&!shapeWorkshopHasLiveAudio()&&(r=Math.max(r,shapeWorkshopDemoAudioEnergy(o))),customShapeGroup.userData||(customShapeGroup.userData={}),!a){customShapeGroup.userData.autoSpinY=(customShapeGroup.userData.autoSpinY||0)+e*(.03+r*.026);var i=(orbit.centerLocked?0:(headParallax.active?headParallax.x*.5:0)+gestureRotation.y)+customShapeGroup.userData.autoSpinY,s=orbit.centerLocked?0:(headParallax.active?-headParallax.y*.35:0)+gestureRotation.x;customShapeGroup.rotation.y+=(i-customShapeGroup.rotation.y)*.055,customShapeGroup.rotation.x+=(s-customShapeGroup.rotation.x)*.055}customShapeGroup.children.forEach(function(l,u){var n=l.userData||{},d=n.primitive;if(n.coverMesh&&!n.coverParticles){var v=d?d.audioFollow*r:0;!a&&d&&!t&&(l.rotation.z+=e*(d.rotation*.18+v*.03),l.rotation.y+=e*(d.rotation*.045+v*.018)),l.material&&(l.material.opacity=clampRange((n.coverBaseOpacity||.22)*(.88+Math.min(.22,v*.16)),.08,.58));return}if(!(!d||!l.geometry||!l.geometry.attributes||!l.geometry.attributes.position)){var f=l.geometry.attributes.position,h=f.array,c=l.geometry.userData.basePositions,g=l.geometry.userData.rand;if(!(!c||!g)){for(var M=n.coverParticles?1.9:1.22,R=d.audioFollow*r*M,B=n.layerIndex!=null?n.layerIndex:u,A=mouseActive&&!a?1:0,P=0;P<g.length;P++){var b=P*3,D=Math.sin(o*(.86+d.audioFollow*1.55)+g[P]*6.2831+c[b]*1.3+B),E=Math.cos(o*1.28+g[P]*9.2+c[b+1]*1.8),S=0,T=0;if(A){var k=c[b]-mouseWorld.x,w=c[b+1]-mouseWorld.y,p=k*k+w*w,m=Math.max(0,1-p/1.35)*.09;S=k*m,T=w*m}h[b]=c[b]+Math.cos(o*.36+g[P]*5.1)*R*(n.coverParticles?.034:.022)+S,h[b+1]=c[b+1]+Math.sin(o*.32+g[P]*4.7)*R*(n.coverParticles?.034:.022)+T,h[b+2]=c[b+2]+(D*.72+E*.28)*R*(n.coverParticles?.17+d.depth*.42:.1+d.depth*.3)}if(f.needsUpdate=!0,!a&&!t&&(l.rotation.z+=e*(d.rotation*.18+R*(n.coverParticles?.042:.03)),l.rotation.y+=e*(d.rotation*.045+R*(n.coverParticles?.026:.018))),l.material){var y=n.coverParticles&&n.coverBaseOpacity||d.opacity;l.material.opacity=clampRange(y*(.86+Math.min(.26,R*.18)),.1,1)}}}})}}function tickPresetTransition(){if(presetTransition.active){var e=(uniforms.uTime.value-presetTransition.start)/presetTransition.duration,o=Math.max(0,Math.min(1,e)),a=Math.sin(o*Math.PI),t=presetTransition.to>=4,r=presetTransition.to===5;uniforms.uScatter.value=Math.max(uniforms.uScatter.value,fx.scatter+a*(t?r?.008:.026:.16)),uniforms.uBurstAmt.value=Math.max(uniforms.uBurstAmt.value,a*(r?.045:t?.12:.15)),uniforms.uPointScale.value=fx.point*(1+a*(r?.016:.048)),e>=1&&(presetTransition.active=!1,syncFxUniforms())}}function updateHomeAudioVisual(e){if(emptyHomeActive){var o=document.getElementById("home-wave-track");if(o){var a=performance.now();if(!(homeWaveTrackState.lastAt&&a-homeWaveTrackState.lastAt<80)){homeWaveTrackState.lastAt=a,ensureHomeWaveTrackBars();for(var t=o.children,r=uniforms&&uniforms.uTime?uniforms.uTime.value:performance.now()/1e3,i=0;i<t.length;i++){var s=t.length>1?i/(t.length-1):0,l=0;frequencyData&&frequencyData.length?l=(frequencyData[Math.min(frequencyData.length-1,Math.floor(Math.pow(s,1.2)*(frequencyData.length-1)))]||0)/255:l=.16+Math.sin(r*1.4+i*.34)*.06;var u=clampRange(Math.max(l,smoothBass*.35+smoothMid*.18+beatPulse*.24),.03,1),n=homeWaveTrackState.smooth[i]||0;n+=(u-n)*(u>n?.34:.12),homeWaveTrackState.smooth[i]=n,t[i].style.height=Math.max(4,n*18)+"px",t[i].style.opacity=String(clampRange(.36+n*.68,.32,1))}}}}}
