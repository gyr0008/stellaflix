...
`),transparent:!0,depthWrite:!1,depthTest:!0,blending:THREE.NormalBlending});return skullParticleGroup=new THREE.Points(C,R),skullParticleGroup.frustumCulled=!1,skullParticleGroup.visible=!1,skullParticleGroup.userData.source=e?"asset":"fallback",skullParticleGroup.position.set(SKULL_MODEL_BASE_POSITION.x,SKULL_MODEL_BASE_POSITION.y,SKULL_MODEL_BASE_POSITION.z),skullParticleGroup.scale.setScalar(SKULL_MODEL_SCALE),skullParticleGroup.rotation.x=SKULL_MODEL_BASE_ROTATION_X,skullParticleGroup.rotation.y=SKULL_MODEL_BASE_ROTATION_Y,skullParticleGroup.renderOrder=32,syncSkullParticleColors(),scene.add(skullParticleGroup),skullParticleGroup}function isSkullShelfCompositionActive(){return!(fx&&fx.preset===SKULL_PRESET_INDEX)||!shelfManager||!shelfManager.getMode||shelfManager.getMode()!=="side"?!1:shelfPinnedOpen||shelfVisibility>.18?!0:!!(shelfManager.hasOpenContent&&shelfManager.hasOpenContent())}function clearSkullPresetResidue(){skullParticleOpacity=0,skullAmpPulse=0,skullBeatFlash=0,skullJawOpen=0,skullCameraBlend=0,skullParticleGroup&&(skullParticleGroup.visible=!1,skullParticleGroup.material&&skullParticleGroup.material.uniforms&&(skullParticleGroup.material.uniforms.uOpacity&&(skullParticleGroup.material.uniforms.uOpacity.value=0),skullParticleGroup.material.uniforms.uJawOpen&&(skullParticleGroup.material.uniforms.uJawOpen.value=0),skullParticleGroup.material.uniforms.uSkullFlash&&(skullParticleGroup.material.uniforms.uSkullFlash.value=0)))}function resetSkullPresetView(e,t){if(t=t||{},!!(fx&&fx.preset===SKULL_PRESET_INDEX)&&(skullWheelZoomTarget=0,t.smooth||(skullWheelZoom=0),skullCameraBlend=Math.max(skullCameraBlend,1),!t.keepLyricLock&&typeof stageLyrics<"u"&&stageLyrics&&stageLyrics.group&&stageLyrics.group.userData&&(stageLyrics.group.userData.skullMouthLocked=!1),!t.keepLyricLock&&typeof requestStageLyricCameraSnap=="function"&&requestStageLyricCameraSnap(10),!(!e||!skullParticleGroup))){var a=isSkullShelfCompositionActive();if(skullShelfCameraMix=a?1:0,skullParticleGroup.position.set(a?-1.18:SKULL_MODEL_BASE_POSITION.x,a?.32:SKULL_MODEL_BASE_POSITION.y,SKULL_MODEL_BASE_POSITION.z),skullParticleGroup.scale.setScalar(a?3.02:SKULL_MODEL_SCALE),skullParticleGroup.rotation.set(SKULL_MODEL_BASE_ROTATION_X,SKULL_MODEL_BASE_ROTATION_Y,0),skullParticleGroup.updateMatrixWorld(!0),camera&&typeof setSkullCameraTargetVectors=="function"){var o=innerHeight>innerWidth*1.08;setSkullCameraTargetVectors(skullCameraTargetPos,skullCameraTargetLook,o,a,0),camera.position.copy(skullCameraTargetPos),skullCameraMixedLook.copy(skullCameraTargetLook),camera.lookAt(skullCameraMixedLook),camera.updateProjectionMatrix()}}}function skullBreathOffset(e,t){var a=t?.7:1;return{x:a*(Math.sin(e*.33+1.7)*.028+Math.sin(e*.61+.4)*.01),y:a*(Math.sin(e*.38+.2)*.036+Math.sin(e*.83+2.1)*.012),z:a*(Math.sin(e*.24+2.6)*.026)}}function setSkullCameraTargetVectors(e,t,a,o,r){if(r=Number(r)||0,o){e.set(a?-.06:0,a?-2.36:-2.5,(a?4.88:4.96)+r*.78),t.set(a?-.04:0,a?-.26:-.2,.03);return}e.set(0,a?-2.38:-2.52,(a?4.92:4.98)+r),t.set(0,a?-.28:-.2,.02)}function applySkullCameraPose(e){if(!(freeCamera&&(freeCamera.active||freeCamera.locked||freeCamera.resetTween))){var t=fx&&fx.preset===SKULL_PRESET_INDEX;if(skullCameraBlend+=((t?1:0)-skullCameraBlend)*Math.min(1,e*(t?4.8:7.2)),!(skullCameraBlend<.002)){skullWheelZoom+=(skullWheelZoomTarget-skullWheelZoom)*Math.min(1,e*8);var a=innerHeight>innerWidth*1.08,o=isSkullShelfCompositionActive(),r=o?1:0;skullShelfCameraMix+=(r-skullShelfCameraMix)*Math.min(1,e*(r>skullShelfCameraMix?4.6:5.8)),Math.abs(skullShelfCameraMix-r)<.002&&(skullShelfCameraMix=r),setSkullCameraTargetVectors(skullCameraBasePos,skullCameraBaseLook,a,!1,skullWheelZoom),setSkullCameraTargetVectors(skullCameraShelfPos,skullCameraShelfLook,a,!0,skullWheelZoom),skullCameraTargetPos.copy(skullCameraBasePos).lerp(skullCameraShelfPos,skullShelfCameraMix),skullCameraTargetLook.copy(skullCameraBaseLook).lerp(skullCameraShelfLook,skullShelfCameraMix),camera.position.lerp(skullCameraTargetPos,skullCameraBlend),skullCameraMixedLook.set(orbit.lookAt.x,orbit.lookAt.y,orbit.lookAt.z).lerp(skullCameraTargetLook,skullCameraBlend),camera.lookAt(skullCameraMixedLook),camera.updateProjectionMatrix()}}}function updateSkullParticleLayer(e){var t=fx&&fx.preset===SKULL_PRESET_INDEX;if(t&&!skullParticleAsset.data&&!skullParticleAsset.failed){loadSkullParticleAsset();return}if(!(t&&!skullParticleAsset.data)&&(t&&createSkullParticleLayer(),!!skullParticleGroup)){var a=t?1:0;if(skullParticleOpacity+=(a-skullParticleOpacity)*Math.min(1,e*(t?3.2:2.4)),skullParticleOpacity<.006&&!t){skullParticleGroup.visible=!1;return}skullParticleGroup.visible=!0,skullParticleGroup.material.uniforms.uOpacity.value=skullParticleOpacity*clampRange(.78+(fx.intensity||.85)*.18,.56,1);var o=clampRange(Math.max(0,beatPulse-.16)/.84,0,1.35),r=clampRange(Math.pow(o,1.34)*1.08+Math.max(0,bass-.6)*.18*o,0,1);skullBeatFlash+=(r-skullBeatFlash)*Math.min(1,e*(r>skullBeatFlash?24:6.2)),skullParticleGroup.material.uniforms.uSkullFlash&&(skullParticleGroup.material.uniforms.uSkullFlash.value=skullBeatFlash);var i=clampRange(.6+(.5+.5*Math.sin(uniforms.uTime.value*.5))*.05+bass*.06+skullBeatFlash*.09,.52,.88);skullJawOpen+=(i-skullJawOpen)*Math.min(1,e*(i>skullJawOpen?7.8:3.4)),skullParticleGroup.material.uniforms.uJawOpen&&(skullParticleGroup.material.uniforms.uJawOpen.value=skullJawOpen);var n=isSkullShelfCompositionActive(),l=clampRange(skullShelfCameraMix||(n?1:0),0,1),u=skullBreathOffset(uniforms.uTime.value,n),s=clampRange(bass*.006+mid*.004+skullBeatFlash*.07,0,.09);skullAmpPulse+=(s-skullAmpPulse)*Math.min(1,e*(s>skullAmpPulse?11:4));var d=3.02,v=(SKULL_MODEL_SCALE+(d-SKULL_MODEL_SCALE)*l)*(1+skullAmpPulse)*clampRange(1-skullWheelZoom*.055,.92,1.08),p=-1.18,h=.32,c=SKULL_MODEL_BASE_POSITION.x+(p-SKULL_MODEL_BASE_POSITION.x)*l+u.x,g=SKULL_MODEL_BASE_POSITION.y+(h-SKULL_MODEL_BASE_POSITION.y)*l+u.y,C=SKULL_MODEL_BASE_POSITION.z+u.z;skullParticleGroup.position.x+=(c-skullParticleGroup.position.x)*Math.min(1,e*4.2),skullParticleGroup.position.y+=(g-skullParticleGroup.position.y)*Math.min(1,e*4.8),skullParticleGroup.position.z+=(C-skullParticleGroup.position.z)*Math.min(1,e*4.2),skullParticleGroup.scale.x+=(v-skullParticleGroup.scale.x)*Math.min(1,e*4.6),skullParticleGroup.scale.y=skullParticleGroup.scale.x,skullParticleGroup.scale.z=skullParticleGroup.scale.x;var R=SKULL_MODEL_BASE_ROTATION_Y+(orbit.centerLocked?0:(headParallax.active?headParallax.x*.5:0)+gestureRotation.y),k=SKULL_MODEL_BASE_ROTATION_X+(orbit.centerLocked?0:(headParallax.active?-headParallax.y*.35:0)+gestureRotation.x),A=Math.min(1,e*7.4);skullParticleGroup.rotation.y+=(R-skullParticleGroup.rotation.y)*A,skullParticleGroup.rotation.x+=(k-skullParticleGroup.rotation.x)*A,skullParticleGroup.rotation.z+=(0-skullParticleGroup.rotation.z)*Math.min(1,e*6)}}var BACK_COVER_COUNT=3e3,backCoverGroup=null,backCoverColorArr=null;function createBackCoverLayer(){if(!backCoverGroup){for(var e=new THREE.BufferGeometry,t=new Float32Array(BACK_COVER_COUNT*3),a=new Float32Array(BACK_COVER_COUNT*3),o=new Float32Array(BACK_COVER_COUNT),r=new Float32Array(BACK_COVER_COUNT*2),i=0;i<BACK_COVER_COUNT;i++){var n=Math.random(),l=Math.random();t[i*3]=(n-.5)*PLANE_SIZE,t[i*3+1]=(l-.5)*PLANE_SIZE,t[i*3+2]=-1.5-Math.random()*.4,r[i*2]=1-n,r[i*2+1]=l,o[i]=Math.random(),a[i*3]=.7,a[i*3+1]=.6,a[i*3+2]=.8}e.setAttribute("position",new THREE.BufferAttribute(t,3)),e.setAttribute("aColor",new THREE.BufferAttribute(a,3)),e.setAttribute("aRand",new THREE.BufferAttribute(o,1)),e.setAttribute("aUv",new THREE.BufferAttribute(r,2));var u=`
  ...
  `,d=new THREE.ShaderMaterial({uniforms:{uTime:uniforms.uTime,uBass:uniforms.uBass,uPixel:uniforms.uPixel,uDotTex:uniforms.uDotTex,uAlpha:uniforms.uAlpha},vertexShader:u,fragmentShader:s,transparent:!0,depthWrite:!1,blending:THREE.NormalBlending});backCoverGroup=new THREE.Points(e,d),backCoverGroup.frustumCulled=!1,backCoverColorArr=a,scene.add(backCoverGroup)}}function destroyBackCoverLayer(){backCoverGroup&&(scene.remove(backCoverGroup),backCoverGroup.geometry.dispose(),backCoverGroup.material.dispose(),backCoverGroup=null,backCoverColorArr=null)}function refreshBackCoverColorsFromCanvas(e){if(!(!backCoverGroup||!e||!backCoverColorArr)){for(var t=e.getContext("2d"),a=t.getImageData(0,0,e.width,e.height).data,o=e.width,r=e.height,i=backCoverGroup.geometry.attributes,n=i.aUv.array,l=0;l<BACK_COVER_COUNT;l++){var u=n[l*2],s=n[l*2+1],d=Math.floor(u*o),v=Math.floor(s*r),p=(v*o+d)*4;backCoverColorArr[l*3]=a[p]/255*.85,backCoverColorArr[l*3+1]=a[p+1]/255*.85,backCoverColorArr[l*3+2]=a[p+2]/255*.85}i.aColor.needsUpdate=!0}}function updateFloatLayer(e){}function refreshFloatColorsFromCover(e){if(!(!floatGroup||!e)){for(var t=e.getContext("2d"),a=t.getImageData(0,0,e.width,e.height).data,o=e.width,r=e.height,i=0;i<FLOAT_COUNT;i++){var n=Math.floor(Math.random()*o),l=Math.floor(Math.random()*r),u=(l*o+n)*4;floatColorArr[i*3]=a[u]/255*.95,floatColorArr[i*3+1]=a[u+1]/255*.95,floatColorArr[i*3+2]=a[u+2]/255*.95}floatGroup.geometry.attributes.aColor.needsUpdate=!0}}function resetFloatColorsToIdle(){if(!(!floatGroup||!floatColorArr)){for(var e=0;e<FLOAT_COUNT;e++){var t=.88+e%17/17*.12;floatColorArr[e*3]=t,floatColorArr[e*3+1]=t,floatColorArr[e*3+2]=t}floatGroup.geometry.attributes.aColor.needsUpdate=!0}}for(var rippleIdx=0,lastRippleAt=0,lastBassRising=!1,BASS_THRESHOLD=.3,RIPPLE_COOLDOWN=.32,regions=[],ry=0;ry<3;ry++)for(var rx=0;rx<3;rx++)regions.push({x:(rx/2-.5)*PLANE_SIZE*.72,y:(ry/2-.5)*PLANE_SIZE*.72});function triggerRipple(e,t,a){var o=ripples[rippleIdx];o.x=e,o.y=t,o.age=0,o.str=a,rippleIdx=(rippleIdx+1)%RIPPLE_MAX}function updateRipples(e){var t=bass>BASS_THRESHOLD&&!lastBassRising;lastBassRising=bass>BASS_THRESHOLD*.75;var a=uniforms.uTime.value;if(t&&a-lastRippleAt>RIPPLE_COOLDOWN){lastRippleAt=a;for(var o=2+(Math.random()<.5?0:1),r={},i=0;i<o;i++){var n,l=0;do n=Math.floor(Math.random()*9),l++;while(r[n]&&l<12);r[n]=!0;var u=regions[n],s=u.x+(Math.random()-.5)*.7,d=u.y+(Math.random()-.5)*.7,v=.65+bass*1.4+Math.random()*.25;triggerRipple(s,d,v)}}for(var p=0;p<RIPPLE_MAX;p++){var h=ripples[p];h.str>.005&&(h.age+=e,h.age>2&&(h.str=0,h.age=-10));var c=p*4;rippleData[c]=h.x,rippleData[c+1]=h.y,rippleData[c+2]=h.age,rippleData[c+3]=h.str}rippleTex.needsUpdate=!0;for(var g=0,p=0;p<RIPPLE_MAX;p++)ripples[p].str>.005&&g++;uniforms.uRippleCount.value=g}function customShapeRecipeForRender(){return shapeWorkshopState&&shapeWorkshopState.open?shapeWorkshopPreviewRecipeForRender():activeUserShapeRecipe&&fx&&Number(fx.preset)===3?normalizeShapeRecipe(activeUserShapeRecipe):null}function ensureCustomShapeGroup(){return customShapeGroup||(customShapeGroup=new THREE.Group,customShapeGroup.name="MineradioCustomShapePreset",customShapeGroup.visible=!1,customShapeGroup.renderOrder=24,scene.add(customShapeGroup),customShapeGroup)}function disposeCustomShapeObject(e){e&&(e.geometry&&e.geometry.dispose&&e.geometry.dispose(),e.material&&e.material.dispose&&e.material.dispose())}function clearCustomShapeLayer(){if(customShapeGroup){for(;customShapeGroup.children.length;){var e=customShapeGroup.children[0];customShapeGroup.remove(e),disposeCustomShapeObject(e)}customShapeRecipeKey="",customShapeRenderRecipe=null,customShapeGroup.visible=!1}}function customShapeSeedFromId(e,t){for(var a=String(e||"shape")+":"+t,o=0,r=0;r<a.length;r++)o=(o*31+a.charCodeAt(r))%1e5;return o+17}function customShapeRand(e){var t=Math.sin(e*12.9898)*43758.5453;return t-Math.floor(t)}function customShapeCoverSampler(){var e=ensureShapeMaterialCanvas()||coverPickerCanvas||(coverTex&&coverTex.image&&coverTex.image.getContext?coverTex.image:null);if(!e||!e.getContext)return null;try{var t=e.getContext("2d"),a=t.getImageData(0,0,e.width,e.height).data;return function(o,r){var i=clampRange(Math.floor(clampRange(o,0,.999)*e.width),0,e.width-1),n=clampRange(Math.floor(clampRange(r,0,.999)*e.height),0,e.height-1),l=(n*e.width+i)*4;return[a[l]/255,a[l+1]/255,a[l+2]/255]}}catch{return null}}function customShapePalette(){var e=stageLyrics&&(stageLyrics.coverPalette||stageLyrics.palette)||{},t=normalizeHexColor(e.primary||fx.visualTintColor||fxDefaults.visualTintColor||"#9db8cf","#9db8cf"),a=normalizeHexColor(e.secondary||fx.uiAccentColor||fxDefaults.uiAccentColor||"#f4d28a","#f4d28a");return{a:new THREE.Color(t),b:new THREE.Color(a),mono:new THREE.Color("#eaf2f5")}}function customShapeColorForPoint(e,t,a,o,r,i){if(e.material==="mono")return[i.mono.r,i.mono.g,i.mono.b];if(e.material==="cover"&&t){var n=t(a,o),l=.22+customShapeRand(r+21)*.22;return[clampRange(n[0]+l,0,1),clampRange(n[1]+l,0,1),clampRange(n[2]+l,0,1)]}var u=clampRange(.25+customShapeRand(r+9)*.65,0,1),s=i.a.clone().lerp(i.b,e.material==="accent"?.7:u);return[s.r,s.g,s.b]}function customShapeUsesCoverTexture(e){return e=normalizeShapeRecipe(e),!!(e.materialBinding&&e.materialBinding.mode==="cover-texture"&&e.primitives.some(function(t){return t.material==="cover"}))}function customShapeTextureReady(){return!!(ensureShapeMaterialCanvas()||coverTex&&coverTex.image)}function customShapeCoverParticleMaterial(e,t){return new THREE.PointsMaterial({size:clampRange(.03+(Number(t)||0),.028,.09),map:dotTexture,vertexColors:!0,transparent:!0,opacity:clampRange(e,.14,.96),depthWrite:!1,sizeAttenuation:!0,blending:THREE.AdditiveBlending})}function applyCustomShapePrimitiveTransform(e,t){e.position.set(t.x*2.55,-t.y*2.05,t.z*2.55),e.rotation.set(t.depth*.34,t.rotation*Math.PI*.34,t.rotation*Math.PI*2)}function buildCustomShapeCoverParticlePoints(e){e=e||{};var t=Math.max(48,Math.min(1400,Math.round(Number(e.count)||420))),a=Math.max(8,Math.round(Math.sqrt(t*(e.aspect||1)))),o=Math.max(8,Math.ceil(t/a));t=a*o;for(var r=Number(e.width)||1.4,i=Number(e.height)||1.4,n=Number(e.depth)||.18,l=customShapeSeedFromId(e.id||"cover-particles",Number(e.index)||0),u=customShapeCoverSampler(),s=customShapePalette(),d=new Float32Array(t*3),v=new Float32Array(t*3),p=new Float32Array(t),h=new Float32Array(t*3),c=0;c<t;c++){var g=c%a,C=Math.floor(c/a),R=a>1?g/(a-1):.5,k=o>1?C/(o-1):.5,A=customShapeRand(l+c*11+3),P=(R-.5)*r,b=(k-.5)*i,D=(A-.5)*n;v[c*3]=P,v[c*3+1]=b,v[c*3+2]=D,d[c*3]=P,d[c*3+1]=b,d[c*3+2]=D,p[c]=A;var E=u?u(R,k):null;E||(E=[s.a.r,s.a.g,s.a.b]);var S=.08+customShapeRand(l+c*7+17)*.13;h[c*3]=clampRange(E[0]+S,0,1),h[c*3+1]=clampRange(E[1]+S,0,1),h[c*3+2]=clampRange(E[2]+S,0,1)}var T=new THREE.BufferGeometry;T.setAttribute("position",new THREE.BufferAttribute(d,3)),T.setAttribute("color",new THREE.BufferAttribute(h,3)),T.userData.basePositions=v,T.userData.rand=p;var B=customShapeCoverParticleMaterial(e.opacity,e.sizeBoost),w=new THREE.Points(T,B);return w.frustumCulled=!1,w}function customShapeLocalPoint(e,t,a,o){var r=a>1?t/(a-1):0,i=customShapeRand(o+t*3+1),n=customShapeRand(o+t*3+2),l=customShapeRand(o+t*3+3),u=e.size,s=e.depth,d=r*Math.PI*2,v=0,p=0,h=0,c=r,g=n;if(e.type==="line")v=(r-.5)*3.2*u,p=(i-.5)*.08*u,h=(n-.5)*s*1.2,g=.5+p;else if(e.type==="ring"){var C=(.82+(i-.5)*.08)*u;v=Math.cos(d)*C,p=Math.sin(d)*C,h=Math.sin(d*2+n*2)*s*.3,c=.5+Math.cos(d)*.48,g=.5+Math.sin(d)*.48}else if(e.type==="curve"){var R=r*Math.PI*2,k=(i-.5)*.18,A=Math.sin(R),P=Math.sin(R)*Math.cos(R);v=(A*1.46+Math.cos(R)*k)*u,p=(P*1.08+Math.sin(R*2)*k*.5)*u,h=(Math.cos(R*2)*.34+(n-.5)*.42)*s*u,c=clampRange(.5+A*.46,0,1),g=clampRange(.5+P*.46,0,1)}else if(e.type==="plane"||e.type==="card"){var b=Math.max(2,Math.round(Math.sqrt(a*(e.type==="card"?1.55:1)))),D=t%b,E=Math.floor(t/b),S=Math.max(2,Math.ceil(a/b));c=b>1?D/(b-1):.5,g=S>1?E/(S-1):.5;var T=e.type==="card"?1.42:1;v=(c-.5)*2.1*u*T,p=(g-.5)*2.1*u,h=(l-.5)*s*.18}else if(e.type==="spiral"){var B=2.2+s*1.6;d=r*Math.PI*2*B;var w=Math.pow(r,.72)*1.35*u+(i-.5)*.1;v=Math.cos(d)*w,p=Math.sin(d)*w,h=(r-.5)*s*2.4+Math.sin(d*.5)*s*.24,c=.5+Math.cos(d)*Math.min(.48,w*.24),g=.5+Math.sin(d)*Math.min(.48,w*.24)}else if(e.type==="wave"){var f=Math.max(2,Math.round(Math.sqrt(a))),m=t%f,y=Math.floor(t/f),M=Math.max(2,Math.ceil(a/f));c=f>1?m/(f-1):.5,g=M>1?y/(M-1):.5,v=(c-.5)*2.5*u,p=(g-.5)*1.7*u,h=Math.sin(c*Math.PI*3+g*Math.PI*1.6)*s*.62}else if(e.type==="tunnel"){var x=Math.max(4,Math.round(Math.sqrt(a)*.55)),L=t%x,H=Math.floor(t/x),W=H/Math.max(1,Math.ceil(a/x)-1);d=L/x*Math.PI*2+i*.18;var V=(.78+n*.18)*u;v=Math.cos(d)*V,p=Math.sin(d)*V,h=(W-.5)*(2.2+s*3.2),c=L/x,g=W}else if(e.type==="sphere"){var U=Math.acos(1-2*r),K=Math.PI*(3-Math.sqrt(5))*t,z=(.92+(i-.5)*.08+s*.08)*u;v=Math.sin(U)*Math.cos(K)*z,p=Math.cos(U)*z,h=Math.sin(U)*Math.sin(K)*z,c=.5+Math.atan2(h,v)/(Math.PI*2),g=.5-Math.asin(p/Math.max(.001,z))/Math.PI}else if(e.type==="dust"){var _=i*Math.PI*2,N=Math.pow(n,.42)*(1.25+s*1.5)*u;v=Math.cos(_)*N,p=(l-.5)*(1.8+s)*u,h=Math.sin(_)*N+(customShapeRand(o+t*5+4)-.5)*s*2.4,c=i,g=n}else{var I=i*Math.PI*2,Y=Math.pow(n,.55)*.58*u;v=Math.cos(I)*Y,p=Math.sin(I)*Y,h=(l-.5)*s*1.4,c=i,g=n}return{x:v,y:p,z:h,u:clampRange(c,0,1),v:clampRange(g,0,1)}}function buildCustomShapePrimitiveCoverObject(e,t,a){if(e=normalizeShapePrimitive(e,t),a=normalizeShapeRecipe(a),!customShapeTextureReady()||!customShapeUsesCoverTexture(a)||e.material!=="cover"||e.type!=="plane"&&e.type!=="card")return null;var o=e.type==="card"?1.42:1,r=buildCustomShapeCoverParticlePoints({id:e.id+"-cover-particles",index:t,count:Math.max(180,Math.round(e.count*1.25)),width:2.1*e.size*o,height:2.1*e.size,depth:Math.max(.08,e.depth*.32),aspect:o,opacity:e.opacity*(e.type==="card"?.58:.52),sizeBoost:e.size*.01});return r.name="MineradioCustomShapeCoverParticlePrimitive",r.renderOrder=23+t,applyCustomShapePrimitiveTransform(r,e),r.userData.primitive=e,r.userData.layerIndex=t,r.userData.coverParticles=!0,r.userData.coverBaseOpacity=r.material.opacity,r}function buildCustomShapeCoverPlate(e){if(e=normalizeShapeRecipe(e),!customShapeTextureReady()||!customShapeUsesCoverTexture(e))return null;var t=e.primitives.some(function(i){return i.type==="plane"||i.type==="card"});if(t)return null;var a=e.primitives.reduce(function(i,n){return i+n.size},0)/Math.max(1,e.primitives.length),o=clampRange(1.1+a*.32+Math.min(e.primitives.length,4)*.05,1.12,1.62),r=buildCustomShapeCoverParticlePoints({id:"cover-particle-plate",index:0,count:Math.max(360,Math.min(1100,Math.round(shapeRecipeTotalParticles(e)*.72))),width:o,height:o,depth:.2,aspect:1,opacity:.62,sizeBoost:.012});return r.name="MineradioCustomShapeCoverParticlePlate",r.renderOrder=22,r.position.set(0,0,-.32),r.rotation.set(-.1,0,0),r.userData.primitive={id:"cover-particle-plate",type:"plane",x:0,y:0,z:-.12,count:r.geometry&&r.geometry.userData&&r.geometry.userData.rand?r.geometry.userData.rand.length:420,size:1,depth:.38,rotation:.08,audioFollow:.78,opacity:.62,material:"cover"},r.userData.layerIndex=-1,r.userData.coverParticles=!0,r.userData.coverPlate=!0,r.userData.coverBaseOpacity=r.material.opacity,r}function buildCustomShapePrimitiveObject(e,t){e=normalizeShapePrimitive(e,t);for(var a=!!(shapeWorkshopState&&shapeWorkshopState.open&&e.id&&e.id===shapeWorkshopState.selectedId),o=Math.max(8,Math.min(1200,e.count)),r=customShapeSeedFromId(e.id,t),i=new Float32Array(o*3),n=new Float32Array(o*3),l=new Float32Array(o),u=new Float32Array(o*3),s=customShapeCoverSampler(),d=customShapePalette(),v=0;v<o;v++){var p=customShapeLocalPoint(e,v,o,r);n[v*3]=p.x,n[v*3+1]=p.y,n[v*3+2]=p.z,i[v*3]=p.x,i[v*3+1]=p.y,i[v*3+2]=p.z,l[v]=customShapeRand(r+v*7+5);var h=customShapeColorForPoint(e,s,p.u,p.v,r+v,d);u[v*3]=h[0],u[v*3+1]=h[1],u[v*3+2]=h[2]}var c=new THREE.BufferGeometry;c.setAttribute("position",new THREE.BufferAttribute(i,3)),c.setAttribute("color",new THREE.BufferAttribute(u,3)),c.userData.basePositions=n,c.userData.rand=l;var g=new THREE.PointsMaterial({size:clampRange(.026+e.size*.024+e.depth*.012+(a?.014:0),.024,.095),map:dotTexture,vertexColors:!0,transparent:!0,opacity:clampRange(e.opacity*(a?1.16:1),.12,1),depthWrite:!1,sizeAttenuation:!0,blending:a||e.type==="dust"||e.type==="spiral"?THREE.AdditiveBlending:THREE.NormalBlending}),C=new THREE.Points(c,g);return C.frustumCulled=!1,C.renderOrder=24+t,applyCustomShapePrimitiveTransform(C,e),C.userData.primitive=e,C.userData.layerIndex=t,C}function syncCustomShapeLayer(e){var t=customShapeRecipeForRender(),a=ensureCustomShapeGroup();if(shapeWorkshopState&&shapeWorkshopState.open&&!shapeWorkshopState.motionPreview&&(a.rotation.set(0,0,0),a.userData.autoSpinY=0),!t||!t.primitives||!t.primitives.length){clearCustomShapeLayer();return}var o=shapeRecipeRenderKey(t);if(!e&&o===customShapeRecipeKey){a.visible=!0;return}clearCustomShapeLayer(),customShapeRenderRecipe=normalizeShapeRecipe(t);var r=buildCustomShapeCoverPlate(customShapeRenderRecipe);r&&a.add(r),customShapeRenderRecipe.primitives.forEach(function(i,n){var l=buildCustomShapePrimitiveCoverObject(i,n,customShapeRenderRecipe);l&&a.add(l),a.add(buildCustomShapePrimitiveObject(i,n))}),customShapeRecipeKey=o,a.visible=!0}function isCustomShapeRenderActive(){return!!(customShapeGroup&&customShapeGroup.visible&&customShapeRenderRecipe&&customShapeRenderRecipe.primitives&&customShapeRenderRecipe.primitives.length)}function shapeWorkshopHasLiveAudio(){return!!(audio&&playing&&!audio.paused&&!audio.ended)}function shapeWorkshopDemoAudioEnergy(e){var t=Math.pow(Math.max(0,Math.sin(e*Math.PI*1.65)),5),a=Math.pow(Math.max(0,Math.sin(e*Math.PI*.58+1.1)),2);return clampRange(.18+t*.78+a*.16,0,1.12)}function updateCustomShapeLayer(e){if(isCustomShapeRenderActive()){var t=uniforms.uTime.value,a=!!(shapeWorkshopState&&shapeWorkshopState.open&&!shapeWorkshopState.motionPreview),o=typeof isCustomShapeLayerDriftLocked=="function"&&isCustomShapeLayerDriftLocked(customShapeRenderRecipe),r=a?0:clampRange((bass*.58+mid*.3+treble*.22+beatPulse*.55)*(fx.intensity||1),0,1.4);if(!a&&shapeWorkshopState&&shapeWorkshopState.open&&shapeWorkshopState.motionPreview&&!shapeWorkshopHasLiveAudio()&&(r=Math.max(r,shapeWorkshopDemoAudioEnergy(t))),customShapeGroup.userData||(customShapeGroup.userData={}),!a){customShapeGroup.userData.autoSpinY=(customShapeGroup.userData.autoSpinY||0)+e*(.03+r*.026);var i=(orbit.centerLocked?0:(headParallax.active?headParallax.x*.5:0)+gestureRotation.y)+customShapeGroup.userData.autoSpinY,n=orbit.centerLocked?0:(headParallax.active?-headParallax.y*.35:0)+gestureRotation.x;customShapeGroup.rotation.y+=(i-customShapeGroup.rotation.y)*.055,customShapeGroup.rotation.x+=(n-customShapeGroup.rotation.x)*.055}customShapeGroup.children.forEach(function(l,u){var s=l.userData||{},d=s.primitive;if(s.coverMesh&&!s.coverParticles){var v=d?d.audioFollow*r:0;!a&&d&&!o&&(l.rotation.z+=e*(d.rotation*.18+v*.03),l.rotation.y+=e*(d.rotation*.045+v*.018)),l.material&&(l.material.opacity=clampRange((s.coverBaseOpacity||.22)*(.88+Math.min(.22,v*.16)),.08,.58));return}if(!(!d||!l.geometry||!l.geometry.attributes||!l.geometry.attributes.position)){var p=l.geometry.attributes.position,h=p.array,c=l.geometry.userData.basePositions,g=l.geometry.userData.rand;if(!(!c||!g)){for(var C=s.coverParticles?1.9:1.22,R=d.audioFollow*r*C,k=s.layerIndex!=null?s.layerIndex:u,A=mouseActive&&!a?1:0,P=0;P<g.length;P++){var b=P*3,D=Math.sin(t*(.86+d.audioFollow*1.55)+g[P]*6.2831+c[b]*1.3+k),E=Math.cos(t*1.28+g[P]*9.2+c[b+1]*1.8),S=0,T=0;if(A){var B=c[b]-mouseWorld.x,w=c[b+1]-mouseWorld.y,f=B*B+w*w,m=Math.max(0,1-f/1.35)*.09;S=B*m,T=w*m}h[b]=c[b]+Math.cos(t*.36+g[P]*5.1)*R*(s.coverParticles?.034:.022)+S,h[b+1]=c[b+1]+Math.sin(t*.32+g[P]*4.7)*R*(s.coverParticles?.034:.022)+T,h[b+2]=c[b+2]+(D*.72+E*.28)*R*(s.coverParticles?.17+d.depth*.42:.1+d.depth*.3)}if(p.needsUpdate=!0,!a&&!o&&(l.rotation.z+=e*(d.rotation*.18+R*(s.coverParticles?.042:.03)),l.rotation.y+=e*(d.rotation*.045+R*(s.coverParticles?.026:.018))),l.material){var y=s.coverParticles&&s.coverBaseOpacity||d.opacity;l.material.opacity=clampRange(y*(.86+Math.min(.26,R*.18)),.1,1)}}}})}}function tickPresetTransition(){if(presetTransition.active){var e=(uniforms.uTime.value-presetTransition.start)/presetTransition.duration,t=Math.max(0,Math.min(1,e)),a=Math.sin(t*Math.PI),o=presetTransition.to>=4,r=presetTransition.to===5;uniforms.uScatter.value=Math.max(uniforms.uScatter.value,fx.scatter+a*(o?r?.008:.026:.16)),uniforms.uBurstAmt.value=Math.max(uniforms.uBurstAmt.value,a*(r?.045:o?.12:.15)),uniforms.uPointScale.value=fx.point*(1+a*(r?.016:.048)),e>=1&&(presetTransition.active=!1,syncFxUniforms())}}function updateHomeAudioVisual(e){if(emptyHomeActive){var t=document.getElementById("home-wave-track");if(t){var a=performance.now();if(!(homeWaveTrackState.lastAt&&a-homeWaveTrackState.lastAt<80)){homeWaveTrackState.lastAt=a,ensureHomeWaveTrackBars();for(var o=t.children,r=uniforms&&uniforms.uTime?uniforms.uTime.value:performance.now()/1e3,i=0;i<o.length;i++){var n=o.length>1?i/(o.length-1):0,l=0;frequencyData&&frequencyData.length?l=(frequencyData[Math.min(frequencyData.length-1,Math.floor(Math.pow(n,1.2)*(frequencyData.length-1)))]||0)/255:l=.16+Math.sin(r*1.4+i*.34)*.06;var u=clampRange(Math.max(l,smoothBass*.35+smoothMid*.18+beatPulse*.24),.03,1),s=homeWaveTrackState.smooth[i]||0;s+=(u-s)*(u>s?.34:.12),homeWaveTrackState.smooth[i]=s,o[i].style.height=Math.max(4,s*18)+"px",o[i].style.opacity=String(clampRange(.36+s*.68,.32,1))}}}}}
